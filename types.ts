...
// ---- Complexity classifier + router types ----

export type ComplexityRoute = "fast" | "balanced" | "strong" | "deep";

export type ComplexityScoreKey =
  | "context_dependency"
  | "reasoning_depth"
  | "generation_scope"
  | "precision_required"
...
export type ComplexityScores = Record<ComplexityScoreKey, number>;
