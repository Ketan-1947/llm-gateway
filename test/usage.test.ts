...
const A = rec({ model: "claude-haiku-4-5", complexityRoute: "fast", apiKeyId: "key_a", tokensIn: 100, tokensOut: 200, timestamp: "2026-06-01T00:00:00Z", tokensSaved: 10, estCostSaved: 0.00001 });
const B = rec({ model: "claude-opus-4-7", complexityRoute: "deep", apiKeyId: "key_a", tokensIn: 500, tokensOut: 1000, timestamp: "2026-06-10T00:00:00Z" });
const C = rec({ model: "claude-haiku-4-5", complexityRoute: "fast", apiKeyId: "key_b", tokensIn: 50, tokensOut: 50, timestamp: "2026-06-12T00:00:00Z" });
...
check(all.byComplexityRoute.fast?.requests === 2, "byComplexityRoute fast = 2");
check(all.byComplexityRoute.deep?.requests === 1, "byComplexityRoute deep = 1");
